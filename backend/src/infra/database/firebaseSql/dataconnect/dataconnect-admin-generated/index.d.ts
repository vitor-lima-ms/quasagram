...
export function getUserByUid(dc: DataConnect, vars: GetUserByUidVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetUserByUidData>>;
...
export function getUserByUid(vars: GetUserByUidVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetUserByUidData>>;
